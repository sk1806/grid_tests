...
j.setPlatform("EL7")
j.setCPUTime(3600)
j.setInputSandbox(['job.sh', 'job2.sh', 'dfc_tools.py', 'gridTools.py', 'test_1.txt', 'test2_cali.root', 'test2_reco.root', 'upload_search.py'])
j.setOutputSandbox([ "StdErr" , "StdOut"])
j.setExecutable("job2.sh", arguments="", logFile="job.log")
